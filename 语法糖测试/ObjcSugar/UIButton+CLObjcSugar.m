...
+ (instancetype)cl_buttonWithTitle:(NSString *)title fontSize:(CGFloat)fontSize textColor:(UIColor *)textColor {
...
+ (instancetype)cl_buttonWithAttributedText:(NSAttributedString *)attributedText {
    return [self cl_buttonWithAttributedText:attributedText imageName:nil backImageName:nil highlightSuffix:nil];
}

+ (instancetype)cl_buttonWithImageName:(NSString *)imageName highlightSuffix:(NSString *)highlightSuffix {
...
+ (instancetype)cl_buttonWithTitle:(NSString *)title fontSize:(CGFloat)fontSize textColor:(UIColor *)textColor imageName:(NSString *)imageName backImageName:(NSString *)backImageName highlightSuffix:(NSString *)highlightSuffix {
...
+ (instancetype)cl_buttonWithAttributedText:(NSAttributedString *)attributedText imageName:(NSString *)imageName backImageName:(NSString *)backImageName highlightSuffix:(NSString *)highlightSuffix {
