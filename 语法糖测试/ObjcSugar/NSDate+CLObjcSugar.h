...
#pragma mark - 单例
+ (NSDateFormatter *)cl_sharedDateFormatter;
+ (NSCalendar *)cl_sharedCalendar;
...
+ (NSString *)cl_dateStringWithDelta:(NSTimeInterval)delta;
...
@property (nonatomic, readonly) NSString *cl_dateDescription;
